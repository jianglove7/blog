---
title: vue文档笔记——3.过渡&动画
date: 2019-08-17 14:14:11
tags: 
- vue
categories:
- javascript
...
## [4.多个元素的过渡](https://cn.vuejs.org/v2/guide/transitions.html#多个元素的过渡)
...
（类似代码块DocumentFragment）



## [6.列表过渡](https://cn.vuejs.org/v2/guide/transitions.html#列表过渡)
...
<div id="list-demo" class="demo">
  ...
  <transition-group name="list" tag="p"> <!--  tag="p"相当于<p>标签-->
...
## [7.可复用的过渡](https://cn.vuejs.org/v2/guide/transitions.html#可复用的过渡)
...
## [8.动态过渡](https://cn.vuejs.org/v2/guide/transitions.html#动态过渡)
...
总结： done()后可以再赋值：`if (!vm.stop) vm.show = false`
...
## [拓展：赋予设计以生命](https://cn.vuejs.org/v2/guide/transitioning-state.html#赋予设计以生命)
